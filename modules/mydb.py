...
#mycursor.execute("CREATE TABLE players (id INT AUTO_INCREMENT PRIMARY KEY, discord_id INT, name TINYTEXT,level INT, hp DOUBLE, dmg DOUBLE, def DOUBLE, evasion DOUBLE, aim DOUBLE, xp DOUBLE, mainweapon INT, mainarmor INT, mainpotion INT)")
